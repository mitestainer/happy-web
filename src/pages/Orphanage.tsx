        ...
        <div className="orphanage-details">
          ...
          <div className="images">
            {orphanage.images.map((img, index) => {
              return (
                <button key={img.id} className={activeImgIndex === index ? "active" : ''} type="button" onClick={() => setActiveImgIndex(index)}>
          ...
          <div className="orphanage-details-content">
            ...
            <div className="map-container">
              ...
              >
                ...
                />
                <Marker interactive={false} icon={mapIconOptions} position={[orphanage.latitude, orphanage.longitude]} />
              </Map>
